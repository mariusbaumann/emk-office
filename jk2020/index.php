...
<div id="container">
	...
	<a href="fr"><div class="button">Pour le français, cliquez ici</div></a>
	...
	<div class="kacheln">
		...
		<div class="align">
			<a href="testsession.php">
				<div class="element">
					<p class="T2">3. Software bedienen und an einer Testsitzung teilnehmen</p>
			...
			<a href="session.php">
				<div class="element">
					<p class="T2">4. An der Jährlichen Konferenz teilnehmen</p>
					<i class="front-icon fas fa-laptop"></i><br/>
