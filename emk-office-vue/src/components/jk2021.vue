...
<div>
    <div class="row mb-3">	
		<tile :title="genLang == 'de' ? 'Jährliche Konferenz 2021 Startseite ' : 'Interner Bereich FR'" :external="false" :icon="'front-icon far fa-calendar-alt'" :description="genLang == 'de' ? 'Zur Startseite Tagung Teil Schweiz' : 'Interner Bereich FR'" :colWidth="12" url="" :blank="false"/>
    </div>
    <div class="row mb-3">	
    ...
    <div class="row mb-3">	
        ...
        <tile :title="genLang == 'de' ? 'Downloads ': 'FR '" :external="false" :icon="'front-icon fas fa-download'" :description="genLang == 'de' ? 'Nützliche Werkzeuge zum Download ': 'FR'" :colWidth="6" :url="JK"/>
    </div>
    <div class="row mb-3">	
		<tile :title="genLang == 'de' ? 'Cloud-Apps ' : 'VPN '" :external="true" :icon="'front-icon fas fa-server'" :description="genLang == 'de' ? 'Auf im Data-Cencter betriebene Applikationen zugreifen. ' : 'FR' " :colWidth="6" :url="'https://emk.flyingcloud.ch'" :yellowbadge="'Beta'" />
    </div> 
</div>
