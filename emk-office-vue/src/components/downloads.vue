...
<div>
    ...
    <div class="row mb-3">	
		<tile :title="genLang == 'de' ? 'Cloud-Apps ' : 'VPN '" :external="true" :icon="'front-icon fas fa-server'" :description="genLang == 'de' ? 'Auf im Data-Cencter betriebene Applikationen zugreifen. ' : 'FR' " :colWidth="6" :url="'https://emk.flyingcloud.ch'" :beta="true" />
    </div> 
</div>
