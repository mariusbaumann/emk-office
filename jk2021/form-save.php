...
$sql="INSERT INTO delegierte (del_vorname, del_nachname, del_email, del_func, del_mi, del_do, del_fr, del_sa, del_bezirk, del_dismi, del_disdo, del_disfr, del_dissa) VALUES ('".$vorname."','".$nachname."', '".$email."', '".$funktion."', '".$mi."', '".$do."', '".$fr."', '".$sa."', '".$bezirk."', '".$dismi."', '".$disdo."', '".$disfr."', '".$dissa."')";
